...
void OV7670_XCLK_TIM1_init(void)
{
  ...
  }
  {
    ...
    TIM1->CCR1 = 0x0003;                      // 50% duty cycle -> 24MHz * 0.5 =(squere) sig ---___---___---___---___ 
...
//    writeI2C(OV7670_REG_SCALING_PCLK_DIV, &val, 1);
//
//    // COM10 - PCLK & VSYNC polaritet (tvoj dodatak)
//    val = 0x00;  // bit1=VSYNC high, bit0=0 PCLK rising, bit2 HSPOL default low
//    writeI2C(OV7670_REG_COM10, &val, 1);
//
//
//  // --------------------------------------------------
