...
.LFB119:
	...
	@ args = 0, pretend = 0, frame = 8
	@ frame_needed = 0, uses_anonymous_args = 0
	.loc 1 841 5 view .LVU745
	.loc 1 844 5 view .LVU746
	.loc 1 840 1 is_stmt 0 view .LVU747
	push	{r4, r5, r6, r7, lr}
	...
	.loc 1 844 9 view .LVU748
	movs	r3, #128
	.loc 1 845 5 view .LVU749
	add	r1, sp, #7
	movs	r2, #1
	movs	r0, #18
	.loc 1 844 9 view .LVU750
	strb	r3, [sp, #7]
	.loc 1 845 5 is_stmt 1 view .LVU751
	bl	writeI2C
.LVL192:
	.loc 1 846 5 view .LVU752
	movs	r0, #200
	bl	delay_ms
.LVL193:
	.loc 1 849 5 view .LVU753
	.loc 1 849 9 is_stmt 0 view .LVU754
	movs	r5, #0
	.loc 1 850 5 view .LVU755
	add	r1, sp, #7
	movs	r2, #1
	movs	r0, #17
	.loc 1 853 9 view .LVU756
	movs	r4, #4
	.loc 1 849 9 view .LVU757
	strb	r5, [sp, #7]
	.loc 1 850 5 is_stmt 1 view .LVU758
	bl	writeI2C
.LVL194:
	.loc 1 853 5 view .LVU759
	.loc 1 854 5 is_stmt 0 view .LVU760
	add	r1, sp, #7
	movs	r2, #1
	movs	r0, #12
	.loc 1 853 9 view .LVU761
	strb	r4, [sp, #7]
	.loc 1 854 5 is_stmt 1 view .LVU762
	bl	writeI2C
.LVL195:
	.loc 1 857 5 view .LVU763
	.loc 1 858 5 is_stmt 0 view .LVU764
	add	r1, sp, #7
	movs	r2, #1
	movs	r0, #18
	.loc 1 857 9 view .LVU765
	strb	r4, [sp, #7]
	.loc 1 858 5 is_stmt 1 view .LVU766
	.loc 1 861 9 is_stmt 0 view .LVU767
	movs	r7, #26
	.loc 1 858 5 view .LVU768
	bl	writeI2C
.LVL196:
	.loc 1 861 5 is_stmt 1 view .LVU769
	.loc 1 862 5 is_stmt 0 view .LVU770
	add	r1, sp, #7
	movs	r2, #1
	movs	r0, #62
	.loc 1 861 9 view .LVU771
	strb	r7, [sp, #7]
	.loc 1 862 5 is_stmt 1 view .LVU772
	bl	writeI2C
.LVL197:
	.loc 1 865 5 view .LVU773
	.loc 1 865 9 is_stmt 0 view .LVU774
	movs	r3, #22
	.loc 1 866 5 view .LVU775
	add	r1, sp, #7
	movs	r2, #1
	movs	r0, #23
	.loc 1 865 9 view .LVU776
	strb	r3, [sp, #7]
	.loc 1 866 5 is_stmt 1 view .LVU777
	bl	writeI2C
.LVL198:
	.loc 1 867 5 view .LVU778
	.loc 1 868 5 is_stmt 0 view .LVU779
	add	r1, sp, #7
	movs	r2, #1
	movs	r0, #24
	.loc 1 867 9 view .LVU780
	strb	r4, [sp, #7]
	.loc 1 868 5 is_stmt 1 view .LVU781
	.loc 1 869 9 is_stmt 0 view .LVU782
	movs	r6, #164
	.loc 1 868 5 view .LVU783
	bl	writeI2C
.LVL199:
	.loc 1 869 5 is_stmt 1 view .LVU784
	.loc 1 870 5 is_stmt 0 view .LVU785
	add	r1, sp, #7
	movs	r2, #1
	movs	r0, #50
	.loc 1 873 9 view .LVU786
	movs	r4, #2
	.loc 1 869 9 view .LVU787
	strb	r6, [sp, #7]
	.loc 1 870 5 is_stmt 1 view .LVU788
	bl	writeI2C
.LVL200:
	.loc 1 873 5 view .LVU789
	.loc 1 874 5 is_stmt 0 view .LVU790
	add	r1, sp, #7
	movs	r2, #1
	movs	r0, #25
	.loc 1 873 9 view .LVU791
	strb	r4, [sp, #7]
	.loc 1 874 5 is_stmt 1 view .LVU792
	bl	writeI2C
.LVL201:
	.loc 1 875 5 view .LVU793
	.loc 1 875 9 is_stmt 0 view .LVU794
	movs	r3, #122
	.loc 1 876 5 view .LVU795
	mov	r0, r7
	add	r1, sp, #7
	movs	r2, #1
	.loc 1 875 9 view .LVU796
	strb	r3, [sp, #7]
	.loc 1 876 5 is_stmt 1 view .LVU797
	bl	writeI2C
.LVL202:
	.loc 1 877 5 view .LVU798
	.loc 1 878 5 is_stmt 0 view .LVU799
	add	r1, sp, #7
	movs	r2, #1
	movs	r0, #3
	.loc 1 877 9 view .LVU800
	strb	r6, [sp, #7]
	.loc 1 878 5 is_stmt 1 view .LVU801
	bl	writeI2C
.LVL203:
	.loc 1 881 5 view .LVU802
	.loc 1 882 5 is_stmt 0 view .LVU803
	add	r1, sp, #7
	.loc 1 881 9 view .LVU804
	movs	r3, #34
	.loc 1 882 5 view .LVU805
	movs	r2, #1
	movs	r0, #114
	.loc 1 881 9 view .LVU806
	strb	r3, [sp, #7]
	.loc 1 882 5 is_stmt 1 view .LVU807
	bl	writeI2C
.LVL204:
	.loc 1 883 5 view .LVU808
	.loc 1 883 9 is_stmt 0 view .LVU809
	movs	r3, #242
	.loc 1 884 5 view .LVU810
	add	r1, sp, #7
	movs	r2, #1
	movs	r0, #115
	.loc 1 883 9 view .LVU811
	strb	r3, [sp, #7]
	.loc 1 884 5 is_stmt 1 view .LVU812
	bl	writeI2C
.LVL205:
	.loc 1 887 5 view .LVU813
	.loc 1 888 5 is_stmt 0 view .LVU814
	add	r1, sp, #7
	movs	r2, #1
	movs	r0, #21
	.loc 1 887 9 view .LVU815
	strb	r5, [sp, #7]
	.loc 1 888 5 is_stmt 1 view .LVU816
	bl	writeI2C
.LVL206:
	.loc 1 895 5 view .LVU817
	.loc 1 895 9 is_stmt 0 view .LVU818
	movs	r3, #208
	.loc 1 896 5 view .LVU819
	add	r1, sp, #7
	movs	r2, #1
	movs	r0, #64
	.loc 1 895 9 view .LVU820
	strb	r3, [sp, #7]
	.loc 1 896 5 is_stmt 1 view .LVU821
	bl	writeI2C
.LVL207:
	.loc 1 899 5 view .LVU822
	.loc 1 900 5 is_stmt 0 view .LVU823
	add	r1, sp, #7
	movs	r2, #1
	movs	r0, #162
	.loc 1 899 9 view .LVU824
	strb	r4, [sp, #7]
	.loc 1 900 5 is_stmt 1 view .LVU825
	bl	writeI2C
.LVL208:
	.loc 1 905 5 view .LVU826
	.loc 1 906 5 is_stmt 0 view .LVU827
	add	r1, sp, #7
	.loc 1 905 9 view .LVU828
	movs	r3, #64
	.loc 1 906 5 view .LVU829
	movs	r2, #1
	movs	r0, #86
	.loc 1 905 9 view .LVU830
	strb	r3, [sp, #7]
	.loc 1 906 5 is_stmt 1 view .LVU831
	bl	writeI2C
.LVL209:
	.loc 1 910 5 view .LVU832
	.loc 1 910 9 is_stmt 0 view .LVU833
	movs	r3, #231
	.loc 1 911 5 view .LVU834
	movs	r2, #1
	add	r1, sp, #7
	movs	r0, #19
	.loc 1 910 9 view .LVU835
	strb	r3, [sp, #7]
	.loc 1 911 5 is_stmt 1 view .LVU836
	bl	writeI2C
.LVL210:
	.loc 1 930 1 is_stmt 0 view .LVU837
	add	sp, sp, #12
	.cfi_def_cfa_offset 20
	@ sp needed
	pop	{r4, r5, r6, r7, pc}
