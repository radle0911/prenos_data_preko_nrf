...
void initLIS320DL(void)
{
  ...
  // upisivanje low i kada se zavrsi high
  SPI1_CS_LOW;
  txByteSPI1(lis302dl_CTRL_REG1);     // odabiremo adresu u kojoj zelimo da upisemo podatke 
  ...
  SPI1_CS_LOW;
  txByteSPI1(lis302dl_CTRL_REG1|lis302dl_CTRL_REG1_DR_READ);    
  ...
  SPI1_CS_LOW;                                                    // Govori LIS302DL da ce naredni bajt koji posalje biti citani sadrzaj sa te adrese.
